  ...
  <div class="container">
    <div class="clock">
      <div class="clock_circle">
        ...
        <div class="clock_circle_hour" :style="`transform: rotate(${rotateHour}deg)`"></div>
        <div class="clock_circle_minute" :style="`transform: rotate(${rotateMinute}deg)`"></div>
      </div>
...
.clock {
  ...
  background: #d9dacc;
  border-radius: 40px;
  box-shadow: 6px 6px 0px 0px rgb(179, 179, 179), 12px 12px 0px 0px rgba(37, 37, 37, 0.329),
    inset 6px 6px 0px 0px rgba(179, 179, 179, 0.5), inset 7px 7px 0px 0px rgba(37, 37, 37, 0.067);
